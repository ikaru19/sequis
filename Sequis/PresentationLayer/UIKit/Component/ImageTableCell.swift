...
class ImageTableCell: UITableViewCell {
    public static let identifier: String = "ImageTableCell"
    private var vwContainer: UIView?
    private var ivContent: UIImageView?
    private var lbAuthor: UILabel?
    ...
    func updateUI(with data: Domain.ImageEntity) {
        self.data = data
        lbAuthor?.text = "Author:\n \(data.author)"
        let url = URL(string: data.downloadURL)
...
private extension ImageTableCell {
    func initDesign() {
        ...
        lbAuthor.snp.makeConstraints { (make: ConstraintMaker) -> Void in
